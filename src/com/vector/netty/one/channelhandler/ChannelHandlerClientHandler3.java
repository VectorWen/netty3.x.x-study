 ...
 *
 */
public class ChannelHandlerClientHandler3  extends SimpleChannelUpstreamHandler{
	
	public void channelConnected(ChannelHandlerContext ctx, ChannelStateEvent e)
			throws Exception {
		super.channelConnected(ctx, e); 
		
		System.out.println("连接到了服务了3");
	...
	public void messageReceived(ChannelHandlerContext ctx, MessageEvent e) {
		...
		System.out.println("1 -- "+channelBufferServer.toString(Charset.forName("utf8")));
